...
\inforev{директор НИИ физики ЮФУ, доктора физико-математических наук}
...
\annotationeng{The paper presents the results of studies of spectral and luminescent 
properties of new series glass multi compositions based on borate and 
bismuth glass heavily doped with terbium, and investigate the regularity of 
the characteristics of the obtained samples at different concentrations of 
bismuth and activator and the mutual effect on the borate glass matrix. It 
is shown that the intensity of spontaneous radiation increases with an 
increase in the concentration of terbium. Three main absorption bands were 
found due to fluctuations of complexes in borate glass. Characteristic 
absorption peaks of terbium ions at 367, 377 and 485 nm are observed, 
corresponding to the transitions $^{7}$F$_{6} \to {}^{5}$D$_{4}$, 
$^{7}$F$_{6} \to ^{5}$G$_{6}$, $^{7}$F$_{6} \to {}^{5}$L$_{10}$. The 
physical parameters of a multicomponent glass doped with Tb$^{3+}$ ions are 
calculated. The resulting phosphors have high photoluminescent properties 
and can be used in various optical applications.}
...
\begin{figure}
\centerline{\includegraphics[width=4.09in,height=2.31in]{hammud1}}
...
\captionf{Samples of multicomponent borate glasses: (a) Sample series of 
Tb$^{3+}$ -- doped bismuth borate glass with different concentrations. (b) 
Glasses under 365 nm excitation}
\label{fig1}
\end{figure}
...
\begin{figure}
\centerline{\includegraphics[width=.55\textwidth]{hammud2}}
\caption{Инфракрасные Фурье-спектры боратного стекла}
\captionf{Infrared Fourier spectra of borate glass}
\label{fig2}
\end{figure}
...
\begin{figure}
\centerline{\includegraphics[width=.55\textwidth]{hammud3}}
\caption{Спектры пропускания многокомпонентного стекла бората висмута с 
различной концентрацией Tb$_{2}$O$_{3}$}
\captionf{Transmission spectra of multicomponent bismuth borate glass with 
different concentrations of Tb$_{2}$O$_{3}$}
\label{fig3}
\end{figure}
...
\begin{figure}
\centerline{\includegraphics[width=\textwidth]{hammud5}}
\caption{Графическое определение прямой ширины запрещенной (a) и непрямой (b) 
зоны многокомпонентного боро-висмутного стекла}
\captionf{Graphical determination of the direct width of the forbidden (a) and 
indirect (b) zones of multicomponent boron-bismuth glass}
\label{fig5}
\end{figure}
...
\begin{figure}
\centerline{\includegraphics[width=.65\textwidth]{hammud6}}
...
\begin{figure}
\centerline{\includegraphics[width=.65\textwidth]{hammud7}}
\caption{Спектры фотолюминесценции стекла бората висмута, легированного 
ионами Tb$^{3+}$, возбуждение при 274 нм}
\captionf{Photoluminescence spectra of bismuth borate glass doped Tb$^{3+}$ 
ions }
\label{fig7}
\end{figure}
...
Chemistry, 2023, vol. 208(11), 110874. \doi{10.1016/j.radphyschem.2023.110874} 
...
application, J. Alloys Compd. 2017, vol. 704, pp. 557--564. \doi{10.1016/j.jallcom.2017.02.056}
...
50--61. \doi{10.37934/arfmts.80.1.5061}
...
laser applications. Mater. Res. Bull. 2015, vol. 67, pp. 196--200. \doi{10.1016/j.materresbull.2015.02.062}
...
Vol. 49, Issue 12, pp. 20772-20783. \doi{10.1016/j.ceramint.2023.03.209}.
...
204--207. \doi{10.1016/j.physb.2009.08.055}
...
159--166. \doi{10.1016/j.jnoncrysol.2019.03.007}
...
glasses, Radiat. Phys. Chem., 2013, vol. 86, pp. 23--30. \doi{10.1016/j.radphyschem.2013.01.031}
...
glass system. Optik, 2023, vol. 274, 170507. \doi{10.1016/j.ijleo.2023.170507}
...
1736-1740. \doi{10.1063/1.360962}
...
95, pp. 36--41. \doi{10.1016/j.optlastec.2017.04.016}
